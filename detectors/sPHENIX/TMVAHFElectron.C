...
int TMVAHFElectron( TString myMethodList = "" )
{
   ...
   TTree *signalTree     = ((TTree*)input->Get("ntp"))->CopyTree("signal==1");
   ...
   dataloader->AddVariable( "clus_e_outer_cemc", 'F' );
   dataloader->AddVariable( "clus_e_outer_hcalin", 'F' );
   dataloader->AddVariable( "clus_e_outer_hcalout", 'F' );
...
int main( int argc, char** argv )
{
   ...
   return TMVAHFElectron(methodList);
}
